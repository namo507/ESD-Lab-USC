...
function assistantStatus(reason = "upstream-unavailable", env = null) {
  if (env?.DASHBOARD_ASSISTANT_API_KEY) {
    return {
      ...
      message: "The ESD Buddy assistant is ready through the Pages edge runtime.",
      fallback: false,
      reason,
      freshness: {
...
function assistantReply(message) {
  ...
  return "The public Pages fallback assistant can answer high-level dashboard navigation questions while the hosted assistant is unavailable. Dashboard data remains mocked and de-identified in the browser build.";
}
...
function presentationPlan(concept, options = {}) {
  ...
  return {
    plan: {
      ...
      disclaimer:
        "This deck was generated by the Cloudflare Pages fallback while the hosted assistant was unavailable. It is de-identified and carries no lab-specific citations.",
      grounded: false,
      citations: [],
      concept: topic,
