...
export const INSIGHTS: Record<string, InsightData> = {
  ...
  "lab-ops-surface-status": { term: "Dashboard status", body: "This inventory summarizes what the website already shows across the ESD Lab front door, REDCap, Participants, Study Analytics, and Assistant surfaces, plus each area's next operational need." },
  ...
  "dyn-discovery": { term: "Dynamics & Dyads", body: "This section links to the V2 relationship-over-time surfaces: dyadic physiology, gaze, phase dynamics, transitions, longitudinal synthesis, and decision support." },
