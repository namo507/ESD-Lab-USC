...
export const INSIGHTS: Record<string, InsightData> = {
  ...
  "assistant-model-clinical": { term: "Assistant model", body: "ESD Buddy runs on a local Ollama model served by the dashboard backend. Prompts stay inside the deployment, and the browser never calls the model endpoint directly." },
  ...
  "pm-status": { term: "Assistant status", body: "Presentation generation uses the same backend-routed Ollama assistant as ESD Buddy. Ready, degraded, and limited fallback states are shown without exposing endpoints or reasoning traces." },
