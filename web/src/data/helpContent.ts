...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  { term: "LM Studio", source: "dashboard", definition: "The local assistant runtime referenced by the dashboard. Prompts are scrubbed before they leave the browser." },
...
export const OPERATOR_REFERENCES: OperatorReference[] = [
  ...
  { group: "Compliance", title: "PHI processing banner", href: "/overview", summary: "Confirms HIPAA-compliant audit logging, REDCap proxy identifier stripping, LM Studio prompt scrubbing, IRB protocol, and session age.", interactions: ["Dismiss in development", "Read IRB protocol"] },
  ...
  { group: "Lab Tools", title: "Presentation Maker", href: "/presentation-maker", summary: "Browser-generated slide deck planner and export surface powered by the local assistant.", interactions: ["Generate plan", "Download deck", "Ask Buddy"] },
